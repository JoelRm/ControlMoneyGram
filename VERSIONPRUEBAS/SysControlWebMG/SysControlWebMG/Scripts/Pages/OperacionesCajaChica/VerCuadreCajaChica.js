var app_CuadreCajaChica = (function (win, doc) {
    ...
    const data = {
        ...
        urlGenerarReporteOperacionesCajaChica: '/OperacionCajaChica/ObtenerCuadreCajaChica',
    ...
    function init() {
        cargaInicial();
        formatoRangoFecha();
        document.getElementById("btnBuscarCuadreCajaChica").addEventListener("click", verCuadreCajaChica);
    ...
    function verCuadreCajaChica() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.lstCuadreCajaChica.length > 0) {
                    $("#txtCajaChicaActualSoles").val(data.lstCuadreCajaChica[0].CajaChicaSolesSistema);
                    $("#txtCajaChicaSolesManual").val(data.lstCuadreCajaChica[0].CajaChicaSolesCuadre);

                    if ((data.lstCuadreCajaChica[0].CajaChicaSolesSistema) > 0) {
                        ($("#txtTotalSoles")).val(data.lstCuadreCajaChica[0].CajaChicaSolesSistema - data.lstCuadreCajaChica[0].CajaChicaSolesCuadre);
                    }
                    else {
                        ($("#txtTotalSoles")).val(data.lstCuadreCajaChica[0].CajaChicaSolesSistema + data.lstCuadreCajaChica[0].CajaChicaSolesCuadre)
                    }
                    $("#txtCajaChicaActualDolares").val(data.lstCuadreCajaChica[0].CajaChicaDolaresSistema);
                    $("#txtCajaChicaDolaresManual").val(data.lstCuadreCajaChica[0].CajaChicaDolaresCuadre);

                    if ((data.lstCuadreCajaChica[0].CajaChicaDolaresSistema) > 0) {
                        ($("#txtTotalDolares")).val(data.lstCuadreCajaChica[0].CajaChicaDolaresSistema - data.lstCuadreCajaChica[0].CajaChicaDolaresCuadre);
                    }
                    else {
                        ($("#txtTotalDolares")).val(data.lstCuadreCajaChica[0].CajaChicaDolaresSistema + data.lstCuadreCajaChica[0].CajaChicaDolaresCuadre);
                    }
                    $("#txtCajaChicaActualEuros").val(data.lstCuadreCajaChica[0].CajaChicaEurosSistema);
                    $("#txtCajaChicaEurosManual").val(data.lstCuadreCajaChica[0].CajaChicaEurosCuadre);

                    if ((data.lstCuadreCajaChica[0].CajaChicaEurosSistema) > 0) {
                        ($("#txtTotalEuros")).val(data.lstCuadreCajaChica[0].CajaChicaEurosSistema - data.lstCuadreCajaChica[0].CajaChicaEurosCuadre);
                    }
                    else {
                        ($("#txtTotalEuros")).val(data.lstCuadreCajaChica[0].CajaChicaEurosSistema + data.lstCuadreCajaChica[0].CajaChicaEurosCuadre);
                    }
                    var ArrDatosCuadre = JSON.parse(data.lstCuadreCajaChica[0].CantidadxBilletexMoneda);
                    ...
                    $("#TxtDeteriorados").val(data.lstCuadreCajaChica[0].NumeroBilletesDeteriorados);
                    $("#txtComentario").val(data.lstCuadreCajaChica[0].Comentario);
    ...
    function changeCboMoneda() {
        ...
        function limpiarTablas() {
            $("#txtCajaChicaActualSoles").val('');
            $("#txtCajaChicaSolesManual").val('');
            $("#txtTotalSoles").val('');
            $("#txtCajaChicaActualDolares").val('');
            $("#txtCajaChicaDolaresManual").val('');
            $("#txtTotalDolares").val('');
            $("#txtCajaChicaActualEuros").val('');
            $("#txtCajaChicaEurosManual").val('');
            $("#txtTotalEuros").val('');
            $("#TxtDeteriorados").val('');
            $("#txtComentario").val(''); 
